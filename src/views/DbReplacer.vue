<template>
  <app-page title="Рефактор БД">
    <div class="d-flex align-items-center">
      <button class="btn btn-success" @click="start" type="button">Start</button>
      <button class="btn btn-danger ms-2" @click="stop" type="button">Stop</button>
    </div>
  </app-page>
</template>
